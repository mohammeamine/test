...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(app)/admin/classes` | `/admin/classes` | `/(app)/admin/courses` | `/admin/courses` | `/(app)/admin/dashboard` | `/admin/dashboard` | `/(app)/admin/logs` | `/admin/logs` | `/(app)/admin/reports` | `/admin/reports` | `/(app)/admin/settings` | `/admin/settings` | `/(app)/admin/users` | `/admin/users` | `/(app)/admin/_layout` | `/admin/_layout` | `/(app)/parent/children` | `/parent/children` | `/(app)/parent/dashboard` | `/parent/dashboard` | `/(app)/parent/profile` | `/parent/profile` | `/(app)/parent/_layout` | `/parent/_layout` | `/(app)/student/courses` | `/student/courses` | `/(app)/student/dashboard` | `/student/dashboard` | `/(app)/student/profile` | `/student/profile` | `/(app)/student/_layout` | `/student/_layout` | `/(app)/teacher/attendance` | `/teacher/attendance` | `/(app)/teacher/classes` | `/teacher/classes` | `/(app)/teacher/dashboard` | `/teacher/dashboard` | `/(app)/teacher/profile` | `/teacher/profile` | `/(app)/teacher/_layout` | `/teacher/_layout` | `/(app)/_layout` | `/_layout` | `/(auth)/(parent)/` | `/(auth)/(parent)` | `/(auth)/(parent)/_layout` | `/(auth)/(student)/` | `/(auth)/(student)` | `/(auth)/(student)/_layout` | `/(auth)/(teacher)/` | `/(auth)/(teacher)` | `/(auth)/(teacher)/_layout` | `/(auth)/forgot-password` | `/forgot-password` | `/(auth)/login` | `/login` | `/(auth)/role-select` | `/role-select` | `/(auth)/signup` | `/signup` | `/(auth)/_layout`;
  // prettier-ignore
