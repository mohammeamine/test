...
export default function MessagesScreen() {
  ...
  const chats = [
    {
      ...
      subject: 'Mathematics',
      child: 'Alex Johnson',
      lastMessage: 'Your child has shown great improvement',
      timestamp: '11:30 AM',
      unread: 1,
    },
    {
    ...
    },
    {
      ...
      subject: 'General',
      child: 'All',
      lastMessage: 'Important announcement about school events',
  ...
  const messages = [
    {
      ...
      chatId: '1',
      sender: 'John Smith',
      content: 'Hello! I wanted to discuss Alex\'s progress in Mathematics.',
      timestamp: '11:25 AM',
      isOwn: false,
    },
    {
      ...
      chatId: '1',
      sender: 'You',
      content: 'Thank you for reaching out. How is Alex doing?',
      timestamp: '11:28 AM',
      isOwn: true,
    },
    {
      ...
      chatId: '1',
      sender: 'John Smith',
      content: 'Your child has shown great improvement',
      timestamp: '11:30 AM',
      isOwn: false,
    },
  ];
  ...
  const filteredChats = chats.filter(chat =>
    ...
    chat.child.toLowerCase().includes(searchQuery.toLowerCase())
  );
    ...
    >
      ...
      <View style={styles.chatInfo}>
        ...
        <Text style={styles.chatRole}>
          {chat.role} - {chat.subject}
          {chat.child !== 'All' && ` (${chat.child})`}
        </Text>
        <Text 
          ...
          <>
            <View style={styles.chatHeader}>
              ...
              <Text style={styles.headerInfo}>
                ...
                {selectedChatData?.child !== 'All' && ` (${selectedChatData?.child})`}
              </Text>
            </View>
            <ScrollView 
